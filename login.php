...
if (isset($_POST['login'])) {
   ...
   $fetch = "SELECT * FROM `create` WHERE Email = '$email'";
   ...
   if (mysqli_num_rows($data) > 0) {
      ...
      if ($decode) {
         session_start();
         $_SESSION['Name'] = $query['Email'];
         header('location:http://localhost:82/classwork/index.php');
      } else {
         ...
         <div class="container">
            <div class="row ">
               <div class="col-md-8 offset-md-2">
                  ...
                  <form id="request" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" class="main_form">
                     <div class="row">
